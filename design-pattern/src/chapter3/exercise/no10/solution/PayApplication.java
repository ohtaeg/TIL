...
class PayApplication extends Frame implements ActionListener, DocumentListener {
    ...
    public PayApplication(PayPolicy payPolicy) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == calcButton) {
            ...
            // 변경된 코드
            int payAmount = payPolicy.calculate(x, y);
